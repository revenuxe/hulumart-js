...
export const metadata: Metadata = { title: "Contact Hulumart Support", description: "Contact Hulumart in Bengaluru for help buying or selling pre-owned items.", alternates: { canonical: "/contact" } };
