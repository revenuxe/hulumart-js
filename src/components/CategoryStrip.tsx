  ...
  return (
    <section className="mx-auto w-full max-w-md px-6 pb-14 md:max-w-7xl md:px-8 md:pb-20">
      <div className="mb-7 flex flex-col items-start gap-3 md:mb-8 md:flex-row md:items-end md:justify-between">
        <div>
          <p className="text-xs font-bold uppercase tracking-widest text-accent">Shop by category</p>
          <h2 className="mt-1 text-2xl font-bold tracking-tight text-primary md:text-[30px]">Find your next device</h2>
        </div>
